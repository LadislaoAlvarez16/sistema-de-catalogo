    ...
    return (
        <div className="min-h-screen bg-gray-50 p-4 md:p-8 text-gray-900">
            <div className="max-w-4xl mx-auto">
                ...
                <h1 className="text-xl md:text-2xl font-bold text-gray-900 mb-6">Gestionar Categorías</h1>
                ...
                <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-x-auto">
                    <table className="w-full text-left">
                        <thead className="bg-gray-50 border-b border-gray-200">
                            <tr>
                                <th className="px-4 py-3 sm:px-6 sm:py-4 text-xs font-semibold text-gray-500 uppercase">Nombre</th>
                                <th className="px-4 py-3 sm:px-6 sm:py-4 text-xs font-semibold text-gray-500 uppercase text-right">Acciones</th>
                            </tr>
                        </thead>
                        <tbody className="divide-y divide-gray-100">
                            {categorias?.map((cat) => (
                                <tr key={cat.id} className="hover:bg-gray-50 transition">
                                    <td className="px-4 py-3 sm:px-6 sm:py-4">{cat.name}</td>
